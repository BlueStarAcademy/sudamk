    ...
    return (
        ...
        >
            <div className="w-full max-w-[12.25rem]">
                ...
                <button
                    type="button"
                    disabled={hasConfirmed || rouletteBlockingStart}
                    onClick={onConfirm}
                    className="group relative mt-2 w-full overflow-hidden rounded-xl border border-violet-200/35 bg-gradient-to-br from-violet-500 via-fuchsia-600 to-indigo-700 px-4 py-2.5 text-[0.8125rem] font-bold tracking-wide text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.22),0_4px_0_0_rgba(55,48,163,0.55),0_14px_36px_-10px_rgba(139,92,246,0.48)] ring-1 ring-violet-300/25 transition-[transform,box-shadow,filter] duration-200 hover:brightness-[1.08] hover:ring-violet-200/40 active:translate-y-px active:shadow-[inset_0_1px_0_rgba(255,255,255,0.15),0_2px_0_0_rgba(55,48,163,0.5)] disabled:cursor-not-allowed disabled:opacity-45 disabled:hover:brightness-100 sm:px-5 sm:text-sm"
                >
                    <span
