...
/** 대국 결과 모달: 하단 보상 영역에서 가로 스크롤 대신 줄바꿈해 획득 보상을 한눈에 보여준다. */
export const RESULT_MODAL_REWARDS_ROW_MOBILE_WRAP_CLASS =
    'flex min-h-[2.85rem] w-full min-w-0 flex-row flex-wrap content-center items-center justify-center gap-0.5 overflow-visible py-0.5 min-[390px]:gap-1';
