        ...
        >
            {isMobile ? (
                <>
                    ...
                    <div className="flex min-w-0 flex-1 flex-row flex-wrap content-center items-center justify-center gap-2 rounded-lg border border-amber-900/35 bg-amber-950/15 px-2 py-2">
                        <div className={colClass}>
                            <ImageButton
