...
interface GuildWarMissileTowerControlsProps extends Pick<GameProps, 'session' | 'onAction' | 'currentUser'> {
            ...
            <div className="flex-1 flex items-center justify-center gap-6">
                <div className="flex flex-col items-center gap-1">
                    <ImageButton
                        ...
                        count={missilesLeft}
                    />
                    <span className={`text-[11px] font-semibold ${missileDisabled ? 'text-gray-500' : 'text-amber-100'}`}>미사일</span>
                </div>
            </div>
        </footer>
    );
