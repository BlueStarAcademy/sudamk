...
export const GAME_RESULT_MOBILE_VIEWPORT_MAX_HEIGHT_CSS =
    'min(100dvh, calc(100dvh - env(safe-area-inset-top, 0px) - env(safe-area-inset-bottom, 0px) - 4px))';

export const GAME_RESULT_MOBILE_VIEWPORT_MAX_HEIGHT_VH = 100;

/** `calc(100dvh - Npx)` clamp와 함께 쓰는 하단 여백(홈 바·푸터 크롬) */
export const GAME_RESULT_MOBILE_DVH_BOTTOM_GAP_PX = 4;
