...
const TrainingGroundRewardPanel: React.FC<TrainingGroundRewardPanelProps> = ({
    ...
    return (
        <div className="flex h-full w-full min-w-0 shrink-0 flex-col gap-1.5 rounded-lg border border-amber-800/45 bg-gradient-to-b from-amber-950/40 to-black/50 px-2.5 py-2 sm:w-[9.5rem]">
