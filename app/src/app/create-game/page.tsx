        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            >
              ...
              <option value="base">베이스 바둑</option>
              <option value="dice">주사위 바둑</option>
              <option value="hidden">히든 바둑</option>
              <option value="missile">미사일 바둑</option>
              <option value="mix">믹스 바둑</option>
              <option value="omok">오목</option>
              <option value="thief">도둑 바둑</option>
              <option value="ttamok">따목</option>
              <option value="alkkagi">알까기</option>
              <option value="curling">컬링 바둑</option>
            </select>
          </div>
