                ...
                article: {
                    ...
                    blocks: [
                        ...
                        },
                        {
                            type: 'bullets',
                            items: [
                                '1번 부화 슬롯: 기본 부화(환영 알은 약 8초·레벨 10 고정).',
            ...
            },
            {
                ...
                article: {
                    ...
                    blocks: [
                        ...
                        {
                            type: 'paragraph',
                            text: '강화·합성·분해 시 경험치를 획득하며, 레벨업 시 효과가 증가합니다. (제련·재료 변환은 경험치를 주지 않습니다.)',
                        },
                        {
                            type: 'bullets',
                            items: [
                                ...
                                '높은 등급·높은 강화 단계 시도일수록 더 많은 경험치 획득',
                            ],
                        },
                        {
                            type: 'callout',
            ...
            },
            {
                ...
                article: {
                    ...
                    blocks: [
                        {
                            type: 'paragraph',
                            text: '매주 화요일 0시(KST)에 시작해 다음 월요일 0시에 종료됩니다. 전쟁 중 길드원 누구나 하루 2회까지 도전할 수 있습니다.',
                        },
                        {
                            type: 'bullets',
                            items: [
                                '월요일 0~1시 정산, 1~23시 휴식, 23시부터 다음 전쟁 매칭입니다.',
                                '승패 보상은 참여 횟수에 따라 달라집니다(6회 이상 100%, 4~5회 75%, 1~3회 50%).',
                            ],
                        },
                    ],
                },
