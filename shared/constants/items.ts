...
export const CONSUMABLE_ITEMS: (Omit<InventoryItem, 'id'|'createdAt'|'isEquipped'|'level'|'stars'|'options'|'enhancementFails' | 'slot'> & {slot: null, usable?: boolean, sellable?: boolean})[] = [
    ...
    { name: '행동력 회복제(+10)', description: '뭔가 하고싶은 의욕이 생긴다.', type: 'consumable', slot: null, image: '/images/icon/lightning.webp', grade: ItemGrade.Normal, usable: true, sellable: false },
    { name: '행동력 회복제(+20)', description: '뭔가 해야 할 것 같다.', type: 'consumable', slot: null, image: '/images/icon/lightning.webp', grade: ItemGrade.Uncommon, usable: true, sellable: false },
    { name: '행동력 회복제(+30)', description: '바로 경기를 하러 가자.', type: 'consumable', slot: null, image: '/images/icon/lightning.webp', grade: ItemGrade.Rare, usable: true, sellable: false },
];
