...
export const SINGLE_PLAYER_STAGES_BASE: SinglePlayerStageInfo[] = [
    ...
    { id: '초급-11', name: '관문 11', level: SinglePlayerLevel.초급, actionPointCost: 3, boardSize: 9, targetScore: { black: 11, white: 9 }, placements: { black: 4, white: 9, blackPattern: 0, whitePattern: 0, centerBlackStoneChance: 0 }, timeControl: { type: 'fischer', mainTime: 3, increment: 5 }, rewards: { firstClear: { gold: 250, exp: 52 }, repeatClear: { gold: 30, exp: 20 } }, autoScoringTurns: 40, missileCount: 2, strategicRulePreset: 'mix', mixedStrategicModes: [GameMode.Speed, GameMode.Missile] },
