...
export const SINGLE_PLAYER_STAGES_BASE: SinglePlayerStageInfo[] = [
    ...
    { id: '입문-15', name: '스테이지 15', level: SinglePlayerLevel.입문, actionPointCost: 2, boardSize: 9, targetScore: { black: 5, white: 0 }, placements: { black: 3, white: 14, blackPattern: 2, whitePattern: 0, centerBlackStoneChance: 0 }, timeControl: { type: 'byoyomi', mainTime: 5, byoyomiTime: 30, byoyomiCount: 5 }, survivalTurns: 15, rewards: { firstClear: { gold: 150, exp: 20, items: [{ itemId: '봄빛 도복 상의', quantity: 1 }] }, repeatClear: { gold: 10, exp: 10 } } },
    ...
    { id: '입문-20', name: '스테이지 20', level: SinglePlayerLevel.입문, actionPointCost: 2, boardSize: 9, targetScore: { black: 5, white: 0 }, placements: { black: 5, white: 18, blackPattern: 6, whitePattern: 0, centerBlackStoneChance: 0 }, timeControl: { type: 'byoyomi', mainTime: 5, byoyomiTime: 30, byoyomiCount: 5 }, survivalTurns: 20, rewards: { firstClear: { gold: 200, exp: 30, items: [{ itemId: '봄빛 도복 하의', quantity: 1 }] }, repeatClear: { gold: 10, exp: 15 } } },
    // 초급
    ...
    { id: '초급-15', name: '스테이지 15', level: SinglePlayerLevel.초급, actionPointCost: 3, boardSize: 9, targetScore: { black: 12, white: 10 }, placements: { black: 5, white: 13, blackPattern: 0, whitePattern: 0, centerBlackStoneChance: 0 }, timeControl: { type: 'fischer', mainTime: 3, increment: 5 }, rewards: { firstClear: { gold: 250, exp: 60, items: [{ itemId: '은결 바람 부채', quantity: 1 }] }, repeatClear: { gold: 30, exp: 20 } }, autoScoringTurns: 40 },
    ...
    { id: '초급-20', name: '스테이지 20', level: SinglePlayerLevel.초급, actionPointCost: 3, boardSize: 9, targetScore: { black: 15, white: 12 }, placements: { black: 5, white: 20, blackPattern: 0, whitePattern: 0, centerBlackStoneChance: 0 }, timeControl: { type: 'fischer', mainTime: 3, increment: 5 }, rewards: { firstClear: { gold: 300, exp: 120, items: [{ itemId: '단풍결 바둑판', quantity: 1 }] }, repeatClear: { gold: 50, exp: 30 } }, autoScoringTurns: 40 },
    // 중급
