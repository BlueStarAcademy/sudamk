...
import { SPEED_PER_MOVE_SECONDS } from './speedTimePressure.js';
...
/** PVE AI 히든 연출 길이(ms): ai_thinking·포획 연동 hidden_reveal·클라 스파클 동기 */
export const PVE_AI_HIDDEN_REVEAL_DURATION_MS = 3000;
/** AI 히든 아이템 사용 시 "생각" 연출 길이(ms). 끝난 뒤 서버가 Kata로 좌표를 정함. 길드전 클라 대기와 동일 값 유지. */
export const AI_HIDDEN_ITEM_THINKING_DURATION_MS = PVE_AI_HIDDEN_REVEAL_DURATION_MS;
