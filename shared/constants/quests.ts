...
export const DAILY_QUESTS: Omit<Quest, 'id' | 'progress' | 'isClaimed'>[] = [
    ...
    { title: '페어바둑 경기하기(PVP)', description: '페어바둑 PVP 대국 3회', target: 3, reward: { gold: 100 }, activityPoints: 10 },
    { title: '페어바둑 승리하기', description: '페어바둑 PVP 대국 3회 승리', target: 3, reward: { gold: 100 }, activityPoints: 10 },
...
export const WEEKLY_QUESTS: Omit<Quest, 'id' | 'progress' | 'isClaimed'>[] = [
    ...
    { title: '페어바둑 경기하기(PVP)', description: '페어바둑 PVP 대국 15회', target: 15, reward: { gold: 500 }, activityPoints: 10 },
    { title: '페어바둑 승리하기', description: '페어바둑 PVP 대국 15회 승리', target: 15, reward: { gold: 500 }, activityPoints: 10 },
...
export const MONTHLY_QUESTS: Omit<Quest, 'id' | 'progress' | 'isClaimed'>[] = [
    ...
    { title: '페어바둑 경기하기(PVP)', description: '페어바둑 PVP 대국 30회', target: 30, reward: { gold: 1500 }, activityPoints: 10 },
    { title: '페어바둑 승리하기', description: '페어바둑 PVP 대국 30회 승리', target: 30, reward: { gold: 1500 }, activityPoints: 10 },
