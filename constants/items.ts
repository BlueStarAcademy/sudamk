...
export const MYTHIC_STATS_DATA: Record<MythicStat, { name: string; description: string; value: (range: [number, number]) => number; }> = {
    [MythicStat.MannerActionCooldown]: { name: '매너액션 쿨감', description: '매너액션 쿨타임 감소', value: () => 30 }, // Fixed 30s reduction
    [MythicStat.StrategicGoldBonus]: { name: '전략 골드', description: '전략바둑 착수 시 20% 확률 골드(10~50) 최대 5회', value: () => 1 },
    [MythicStat.PlayfulGoldBonus]: { name: '놀이 골드', description: '놀이바둑 60초마다 20% 확률 골드(10~50) 최대 5회', value: () => 1 },
    [MythicStat.DiceGoOddBonus]: { name: '주사위 홀/짝', description: '주사위바둑 홀/짝 아이템 1개 추가', value: () => 1 },
    [MythicStat.AlkkagiSlowBonus]: { name: '슬로우 보너스', description: '알까기/컬링 슬로우 1개 추가', value: () => 1 },
    [MythicStat.AlkkagiAimingBonus]: { name: '조준선 보너스', description: '알까기/컬링 조준선 1개 추가', value: () => 1 },
};
