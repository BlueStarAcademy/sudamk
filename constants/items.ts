...
export const MYTHIC_STATS_DATA: Record<MythicStat, { name: string; description: string; abbrevLabel: string; shortDescription: string; value: (range: [number, number]) => number; }> = {
