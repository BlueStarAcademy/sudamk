...
export const GUILD_RESEARCH_PROJECTS: Record<GuildResearchId, GuildResearchProject> = {
    ...
    [GuildResearchId.ap_regen_boost]: { image: '/images/guild/lab/statlab7.webp', category: GuildResearchCategory.stats, name: '행동력 회복속도 증가', description: '모든 길드원의 행동력 회복 간격이 감소합니다.', maxLevel: 10, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '초', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(10) },
    [GuildResearchId.stat_concentration]: { image: '/images/guild/lab/statlab1.webp', category: GuildResearchCategory.stats, name: '집중력 증가', description: '모든 길드원의 집중력 능력치를 증가시킵니다.', maxLevel: 10, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(10) },
    [GuildResearchId.stat_thinking_speed]: { image: '/images/guild/lab/statlab2.webp', category: GuildResearchCategory.stats, name: '사고속도 증가', description: '모든 길드원의 사고속도 능력치를 증가시킵니다.', maxLevel: 10, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(10) },
    [GuildResearchId.stat_judgment]: { image: '/images/guild/lab/statlab3.webp', category: GuildResearchCategory.stats, name: '판단력 증가', description: '모든 길드원의 판단력 능력치를 증가시킵니다.', maxLevel: 10, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(10) },
    [GuildResearchId.stat_calculation]: { image: '/images/guild/lab/statlab4.webp', category: GuildResearchCategory.stats, name: '계산력 증가', description: '모든 길드원의 계산력 능력치를 증가시킵니다.', maxLevel: 10, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(10) },
    [GuildResearchId.stat_combat_power]: { image: '/images/guild/lab/statlab5.webp', category: GuildResearchCategory.stats, name: '전투력 증가', description: '모든 길드원의 전투력 능력치를 증가시킵니다.', maxLevel: 10, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(10) },
    [GuildResearchId.stat_stability]: { image: '/images/guild/lab/statlab6.webp', category: GuildResearchCategory.stats, name: '안정감 증가', description: '모든 길드원의 안정감 능력치를 증가시킵니다.', maxLevel: 10, baseCost: 30000, costMultiplier: 1.2, baseEffect: 5, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(10) },
    [GuildResearchId.reward_strategic_gold]: { image: '/images/guild/lab/gamelab1.webp', category: GuildResearchCategory.rewards, name: '전략 바둑 골드보상 증가', description: '모든 길드원의 전략 바둑 골드 보상을 증가시킵니다.', maxLevel: 5, baseCost: 30000, costMultiplier: 1.2, baseEffect: 10, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(5) },
    [GuildResearchId.reward_playful_gold]: { image: '/images/guild/lab/gamelab2.webp', category: GuildResearchCategory.rewards, name: '놀이 바둑 골드보상 증가', description: '모든 길드원의 놀이 바둑 골드 보상을 증가시킵니다.', maxLevel: 5, baseCost: 30000, costMultiplier: 1.2, baseEffect: 10, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(5) },
    [GuildResearchId.reward_strategic_xp]: { image: '/images/guild/lab/gamelab3.webp', category: GuildResearchCategory.rewards, name: '전략 바둑 EXP 보상 증가', description: '모든 길드원의 전략 바둑 EXP 보상을 증가시킵니다.', maxLevel: 5, baseCost: 30000, costMultiplier: 1.2, baseEffect: 10, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(5) },
    [GuildResearchId.reward_playful_xp]: { image: '/images/guild/lab/gamelab4.webp', category: GuildResearchCategory.rewards, name: '놀이 바둑 경험치보상 증가', description: '모든 길드원의 놀이 바둑 경험치 보상을 증가시킵니다.', maxLevel: 5, baseCost: 30000, costMultiplier: 1.2, baseEffect: 10, effectUnit: '%', baseTimeHours: 3, timeIncrementHours: 0, requiredGuildLevel: generateRequiredLevels(5) },
};
...
/** 길드 장비 상자 — 상점 이미지 말풍선: `{등급명}` 앞에만 색 적용 */
export const GUILD_EQUIPMENT_BOX_POPOVER_TAIL = '장비 획득. 길드보스전 옵션 확정';

/** 길드 장비 상자 설명 — 레거시/기타 UI용 (등급명 앞에 색 입힐 때 접미사) */
export const GUILD_EQUIPMENT_BOX_DESCRIPTION_SUFFIX =
    ' 등급 장비 1개 획득. 상자를 열면 길드 관련 특수 옵션이 반드시 포함됩니다.';
...
export const GUILD_SHOP_ITEMS: GuildShopItem[] = [
    ...
    { itemId: '중급 강화석', name: '중급 강화석', description: '장비 강화에 사용되는 상급 재료.', cost: 25, image: '/images/materials/materials2.webp', type: 'material', limit: 30, limitType: 'weekly', grade: ItemGrade.Uncommon },
    { itemId: '상급 강화석', name: '상급 강화석', description: '장비 강화에 사용되는 최상급 재료', cost: 50, image: '/images/materials/materials3.webp', type: 'material', limit: 10, limitType: 'weekly', grade: ItemGrade.Rare },
    { itemId: '최상급 강화석', name: '최상급 강화석', description: '장비 강화에 사용되는 희귀 재료', cost: 150, image: '/images/materials/materials4.webp', type: 'material', limit: 5, limitType: 'weekly', grade: ItemGrade.Epic },
