...
export const ADVENTURE_MONSTERS_AMUSEMENT_PARK = [
    ...
    {
        codexId: 'amuse_06',
        imageWebp: `${amuse}/amusement_park_06.webp`,
        name: '풍선판이',
