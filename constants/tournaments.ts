...
// 단계별 기본 보상: shared 단일 소스 (scheduledTasks·클라이언트 동기화)
export {
...
// 10단계 1위 기준: 동네바둑리그=골드 꾸러미 IV×5, 전국바둑대회=재료상자6×2, 월드챔피언십=다이아 꾸러미 IV×3
export const DUNGEON_RANK_REWARDS: Record<TournamentType, Record<number, Record<number, QuestReward>>> = {
    neighborhood: {
        // 10단계 기준: 1위 = 골드 꾸러미 IV × 5개
        10: {
            1: { items: [{ itemId: '골드 꾸러미 IV', quantity: 5 }] },
            2: { items: [{ itemId: '골드 꾸러미 IV', quantity: 3 }] },
            3: { items: [{ itemId: '골드 꾸러미 III', quantity: 3 }] },
            4: { items: [{ itemId: '골드 꾸러미 III', quantity: 2 }] },
            5: { items: [{ itemId: '골드 꾸러미 II', quantity: 2 }] },
            6: { items: [{ itemId: '골드 꾸러미 I', quantity: 2 }] },
        },
        // 9단계: 1위 = 골드 꾸러미 IV × 4개
        9: {
            1: { items: [{ itemId: '골드 꾸러미 IV', quantity: 4 }] },
            2: { items: [{ itemId: '골드 꾸러미 IV', quantity: 2 }] },
            3: { items: [{ itemId: '골드 꾸러미 III', quantity: 2 }] },
            4: { items: [{ itemId: '골드 꾸러미 III', quantity: 1 }] },
            5: { items: [{ itemId: '골드 꾸러미 II', quantity: 1 }] },
            6: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
        },
        // 8단계: 1위 = 골드 꾸러미 III × 4개
        8: {
            1: { items: [{ itemId: '골드 꾸러미 III', quantity: 4 }] },
            2: { items: [{ itemId: '골드 꾸러미 III', quantity: 2 }] },
            3: { items: [{ itemId: '골드 꾸러미 II', quantity: 2 }] },
            4: { items: [{ itemId: '골드 꾸러미 II', quantity: 1 }] },
            5: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
            6: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
        },
        // 7단계: 1위 = 골드 꾸러미 III × 3개
        7: {
            1: { items: [{ itemId: '골드 꾸러미 III', quantity: 3 }] },
            2: { items: [{ itemId: '골드 꾸러미 III', quantity: 2 }] },
            3: { items: [{ itemId: '골드 꾸러미 II', quantity: 2 }] },
            4: { items: [{ itemId: '골드 꾸러미 II', quantity: 1 }] },
            5: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
        ...
        // 6단계: 1위 = 골드 꾸러미 III × 2개
        6: {
            1: { items: [{ itemId: '골드 꾸러미 III', quantity: 2 }] },
            2: { items: [{ itemId: '골드 꾸러미 II', quantity: 2 }] },
            3: { items: [{ itemId: '골드 꾸러미 II', quantity: 1 }] },
            4: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
            5: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
            6: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
        },
        // 5단계: 1위 = 골드 꾸러미 II × 3개
        5: {
            1: { items: [{ itemId: '골드 꾸러미 II', quantity: 3 }] },
            2: { items: [{ itemId: '골드 꾸러미 II', quantity: 2 }] },
            3: { items: [{ itemId: '골드 꾸러미 I', quantity: 2 }] },
            4: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
            5: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
            6: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
        },
        // 4단계: 1위 = 골드 꾸러미 II × 2개
        4: {
            1: { items: [{ itemId: '골드 꾸러미 II', quantity: 2 }] },
            2: { items: [{ itemId: '골드 꾸러미 II', quantity: 1 }] },
            3: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
            4: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
            5: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
            6: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
        },
        // 3단계: 1위 = 골드 꾸러미 I × 3개
        3: {
            1: { items: [{ itemId: '골드 꾸러미 I', quantity: 3 }] },
            2: { items: [{ itemId: '골드 꾸러미 I', quantity: 2 }] },
            3: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
            4: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
            5: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
            6: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
        ...
        // 2단계: 1위 = 골드 꾸러미 I × 2개
        2: {
            1: { items: [{ itemId: '골드 꾸러미 I', quantity: 2 }] },
            2: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
            3: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
            4: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
            5: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
            6: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
        },
        // 1단계 기준: 1위 = 골드 꾸러미 I × 2개
        1: {
            1: { items: [{ itemId: '골드 꾸러미 I', quantity: 2 }] },
            2: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
            3: { items: [{ itemId: '골드 꾸러미 I', quantity: 1 }] },
