...
export const SPECIAL_GAME_MODES = [
  ...
  { mode: GameMode.Speed, name: "스피드 바둑", description: "한 수를 둘 때마다 시간이 추가되는 피셔 방식입니다. 계가 시 남은 시간으로 보너스 집을 얻습니다.", available: true, image: "/images/simbols/simbol3.webp" },
  { mode: GameMode.Base, name: "베이스 바둑", description: "각자 비밀리에 '베이스돌'을 놓아 독특한 시작 판을 만듭니다. 돌이 공개된 후, 초기 형세를 판단하여 흑/백과 덤을 결정하는 입찰을 진행합니다. 상대의 베이스돌을 따내면 보너스 점수를 얻는 전략적인 바둑입니다.", available: true, image: "/images/simbols/simbol4.webp" },
  { mode: GameMode.Hidden, name: "히든 바둑", description: "상대에게 보이지 않는 '히든돌'을 놓아 허를 찌르고, 한정된 '스캔' 아이템으로 상대의 비밀 착수를 간파하는 심리전 바둑입니다. 히든돌을 찾아내 따내면 큰 점수를 얻을 수 있어, 대국 내내 긴장감을 늦출 수 없습니다.", available: true, image: "/images/simbols/simbol5.webp" },
  { mode: GameMode.Missile, name: "미사일 바둑", description: "미사일 아이템으로 내 돌을 움직여 전략적인 행마를 구사하는 바둑입니다.", available: true, image: "/images/simbols/simbol6.webp" },
  { mode: GameMode.Mix, name: "믹스 바둑", description: "따내기, 스피드, 베이스, 히든, 미사일 바둑의 규칙을 2개 이상 섞어서 대결하는 모드입니다.", available: true, image: "/images/simbols/simbol7.webp" }
];
