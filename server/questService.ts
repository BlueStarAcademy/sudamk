...
export const updateQuestProgress = (user: types.User, type: 'win' | 'participate' | 'action_button' | 'tournament_participate' | 'enhancement_attempt' | 'equipment_combine_attempt' | 'equipment_refine_attempt' | 'equipment_disassemble_attempt' | 'craft_attempt' | 'chat_greeting' | 'championship_play' | 'adventure_win' | 'login' | 'claim_daily_milestone_100' | 'claim_weekly_milestone_100', mode?: types.GameMode, amount: number = 1) => {
