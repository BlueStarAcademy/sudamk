...
export function getSelectiveUserUpdate(
    ...
    const fieldMap: Record<string, string[]> = {
        ...
        'INSTANT_CURRENCY_EXCHANGE': ['gold', 'diamonds'],
        'POST_CURRENCY_EXCHANGE_ORDER': ['exchangeState', 'gold', 'diamonds'],
        'FULFILL_CURRENCY_EXCHANGE_ORDER': ['gold', 'diamonds'],
        'CANCEL_CURRENCY_EXCHANGE_ORDER': ['exchangeState', 'gold', 'diamonds'],
        'CLAIM_CURRENCY_EXCHANGE_RECEIPT': ['exchangeState', 'gold', 'diamonds'],
        ...
        'RESET_PAIR_ARENA_STRATEGIC_ALL': ['diamonds', 'stats', 'pairArenaStatsByMode', 'cumulativeRankingScore', 'dailyRankings'],
