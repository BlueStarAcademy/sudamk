...
export const rowToGame = (row: any): types.LiveGameSession | null => {
    ...
    try {
        const game: types.LiveGameSession = {
            ...
            hidden_stones_p1: safeParse(row.hidden_stones_p1, null, row.id, 'hidden_stones_p1'),
            hidden_stones_p2: safeParse(row.hidden_stones_p2, null, row.id, 'hidden_stones_p2'),
            hidden_stones_used_p1: safeParse(row.hidden_stones_used_p1, null, row.id, 'hidden_stones_used_p1'),
            hidden_stones_used_p2: safeParse(row.hidden_stones_used_p2, null, row.id, 'hidden_stones_used_p2'),
